...
[`<div id="content"><img src="../../../../gallery_images/taj-mahal.jpg" style="width: 100%; height: 60%;"><div id="siteNotice"></div><h6 id="firstHeading" class="firstHeading">${locations[1][0]}</h4><a href="/../../../pages/hotels/paris.html" style="color:  rgb(79, 70, 211);">click to visit hotel page </a>  <div ></div></div>`],
[`<div id="content"><img src="../../../../gallery_images/taj-mahal.jpg"" style="width: 100%; height: 60%;"><div id="siteNotice"></div><h6 id="firstHeading" class="firstHeading">${locations[2][0]}</h4><a href="/../../../pages/hotels/toronto.html" style="color:  rgb(79, 70, 211);"  >click to visit hotel page </a>   <div </div></div>`],
